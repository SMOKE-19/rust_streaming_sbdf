...
static int compare_metadata_sort_by_order(const void* lhs_ptr, const void* rhs_ptr)
{
	const struct metadata_sort* lhs = lhs_ptr;
	const struct metadata_sort* rhs = rhs_ptr;
	return lhs->order - rhs->order;
}

static int compare_metadata_sort_by_name(const void* lhs_ptr, const void* rhs_ptr)
{
	const struct metadata_sort* lhs = lhs_ptr;
	const struct metadata_sort* rhs = rhs_ptr;
